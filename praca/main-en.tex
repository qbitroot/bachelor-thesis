...
In preparation of the thesis I have also used artificial intelligence
tools for the purposes of assisted editing of text and for auxiliary
implementation of selected helper functions in the source code. I
